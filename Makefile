...
OBJS=board.o gtp.o move.o ownermap.o pattern3.o pattern.o playout.o probdist.o random.o stone.o tactics.o
SUBDIRS=random replay patternscan montecarlo uct uct/policy playout t-unit

all: all-recursive zzgo

LOCALLIBS=random/random.a replay/replay.a patternscan/patternscan.a montecarlo/montecarlo.a uct/uct.a uct/policy/uctpolicy.a playout/playout.a t-unit/test.a
