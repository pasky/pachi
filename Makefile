...
SUBDIRS=random montecarlo montecasino uct uct/policy

all: all-recursive zzgo

LOCALLIBS=random/random.a montecarlo/montecarlo.a montecasino/montecasino.a uct/uct.a uct/policy/uctpolicy.a
zzgo: $(OBJS) $(LOCALLIBS)
	$(call cmd,link)
