...
int play_random_game(struct board *b, enum stone starting_color, int gamelen, struct playout_ravemap *ravemap, playout_policeman policeman, void *policy);
