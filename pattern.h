...
#define PF_SELFATARI_N		3
	...
	/* Atari move. */
	FEAT_ATARI,
#define PF_ATARI_LADDER		0  /*     The atari'd group gets laddered? */
#define PF_ATARI_KO		1  /*     Atari as ko-threat ? disables selfatari feature. */
#define PF_ATARI_SOME		2  /*     Can atari something */
#define PF_ATARI_N		3
