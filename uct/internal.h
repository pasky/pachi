...
typedef void (*uctp_prior)(struct uct_policy *p, struct tree *tree, struct tree_node *node, struct board *b, enum stone color);
typedef void (*uctp_update)(struct uct_policy *p, struct tree_node *node, struct playout_amafmap *amaf, int result);
