...
void
uct_prior_even(struct uct *u, struct tree_node *node, struct prior_map *map, coord_t c)
{
	/* Q_{even} */
...
void
uct_prior_eye(struct uct *u, struct tree_node *node, struct prior_map *map, coord_t c)
{
...
void
uct_prior_b19(struct uct *u, struct tree_node *node, struct prior_map *map, coord_t c)
{
	/* Q_{b19} */
...
void
uct_prior_grandparent(struct uct *u, struct tree_node *node, struct prior_map *map, coord_t c)
{
	/* Q_{grandparent} */
...
void
uct_prior_playout(struct uct *u, struct tree_node *node, struct prior_map *map, coord_t c)
{
	/* Q_{playout-policy} */
	int assess = 0;
	if (u->playout->assess) {
...
{
	if (u->even_eqex)
		uct_prior_even(u, node, map, c);
	uct_prior_eye(u, node, map, c);
	if (u->b19_eqex)
		uct_prior_b19(u, node, map, c);
	if (u->gp_eqex)
		uct_prior_grandparent(u, node, map, c);
	if (u->policy_eqex)
		uct_prior_playout(u, node, map, c);
}
